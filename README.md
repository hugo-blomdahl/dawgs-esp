...
Commit often, but only when the project compiles correctly and does not crash. Create a pull request to merge to main when something concrete is complete. Especially something that you think will be of use to others :)
